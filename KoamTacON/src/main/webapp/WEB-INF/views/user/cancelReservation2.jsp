            ...
            <section>
                ...
                <div id="tblKDCApprovalList" class="table-wrapper">
                    <table class="alt">
                        <thead>
                            <tr>
                                <th width="3%" style="text-align:center;">순번</th>
                                <th width="6%" style="text-align:center;">연수원</th>
                                <th width="6%" style="text-align:center;">요청일자</th>
                                <th width="6%" style="text-align:center;">시작일</th>
                                <th width="6%" style="text-align:center;">종료일</th>
                                <th width="7%" style="text-align:center;">이용목적</th>
                                <th width="7%" style="text-align:center;">이용요금</th>
                                <th width="7%" style="text-align:center;">취소반려사유</th>
                                <th width="6%" style="text-align:center;">상태</th>
                                <th width="6%" style="text-align:center;">상태변경</th>
                                <th width="6%" style="text-align:center;">체크인남은일자</th>
                                <th width="7%" style="text-align:center;">실제이용자대표이름</th>
                                <th width="7%" style="text-align:center;">핸드폰번호</th>
                                <th width="7%" style="text-align:center;">이메일</th>
                                <th width="7%" style="text-align:center;">차량번호</th>
...
function fn_kdcRegistrationApproval() {
	...
	gf_sendFormWithParamForCallback(frmId, "<c:url value='/admin/approvalManagement/kdcApproval' />", "fn_kdcRegistrationApprovalCallback", cbParam);
	/*
    if (sNo == "" || sNo.length != 6 || !reg.test(sNo)) {
    	...
    	$('#dim-layer-kdc-reg-approval').fadeOut();
    	$("#mloader").css("display", "block");
    	gf_sendForm(frmId, "<c:url value='/admin/approvalManagement/kdcApproval' />", "fn_kdcRegistrationApprovalCallback");
    }
	*/
}
...
function fn_popImage(userId, kdcSeq) {
    ...
    gf_send("<c:url value='/admin/approvalManagement/getKDCPhoto' />", param, "fn_popImageCallbak");
}
...
function fn_getOwnerInfo(ownerId) {
	...
	gf_send("<c:url value='/admin/approvalManagement/getOwnerInfo' />", param, "fn_getOwnerInfoCallbak");
}

						...
						<tfoot style="font-size: 0.8em;">
							<tr>
								<td colspan="5" style="text-align: right;">
									<ul class="actions vertical">
										<li><input type="button" name="btnCreateAdmin"
											id="btnCreateAdmin" value="Create" class="button special" /></li>
									</ul>
								</td>
							</tr>
							<tr>
								<td colspan="5" style="text-align: center;" id="tdPagination"></td>
							</tr>
						</tfoot>
					</table>
				</div>
...
// 					if ($("#flagSave").val() === "I") {
						gf_sendForm(
								frmId,
								"<c:url value='/user/reservationRequest/insertApplication' />",
								"fn_submitAdminInfoCallback");
// 					} else {
// 						gf_sendForm(
// 								frmId,
// 								"<c:url value='/user/reservationRequest/updateApplication' />",
// 								"fn_submitAdminInfoCallback");
// 					}
				}
			}

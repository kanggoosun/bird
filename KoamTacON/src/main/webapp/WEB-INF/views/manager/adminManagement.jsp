						...
						<table class="alt">
							<thead style="text-align: center; font-size: 0.8em;">
								<tr>
									...
									<th width="8%" style="text-align: center;">요청일자</th>
									<th width="5%" style="text-align: center;">법인</th>
									<th width="5%" style="text-align: center;">부서</th>
		...
		function fn_makeTblApplicationList(applicationList, paginationHtml) {
			...
			if (applicationList != null && applicationList.length > 0) {
				for (var i = 0; i < applicationList.length; i++) {
					...
					bodyHtml += "    <td id=\"tduser_id-"+i+"\">"
							+ gfn_nullValue(applicationList[i].user_id) + "</td>";
					bodyHtml += "    <td id=\"tdreq_day-"+i+"\">"
							+ gfn_nullValue(applicationList[i].req_day) + "</td>";
					bodyHtml += "    <td id=\"tdcorp_nm-"+i+"\">"
							+ gfn_nullValue(applicationList[i].corp_nm)
							+ "</td>";
					bodyHtml += "    <td id=\"tddep_nm-"+i+"\">"
							+ gfn_nullValue(applicationList[i].dep_nm)
							+ "</td>";
					bodyHtml += "    <td id=\"tdNAME-"+i+"\">"
							+ gfn_nullValue(applicationList[i].NAME)
							+ "</td>";
					...
					bodyHtml += "    <td id=\"tdphone-"+i+"\">"
							...
							+ "</td>";
					bodyHtml += "    <td id=\"tdreq_reason-"+i+"\">"
							+ gfn_nullValue(applicationList[i].req_reason)
							+ "</td>";
					bodyHtml += "    <td id=\"tdmember_sts-"+i+"\">"
							+ gfn_nullValue(applicationList[i].member_sts)
							+ "</td>";
					bodyHtml += "    <td id=\"tduser_type-"+i+"\">"
							+ gfn_nullValue(applicationList[i].user_type)
							+ "</td>";
					bodyHtml += "    <td id=\"tdactivation-"+i+"\">"
							+ gfn_nullValue(applicationList[i].activation)
							+ "</td>";

            ...
            <section>
                ...
                <div id="tblKDCApprovalList" class="table-wrapper">
                    <table class="alt">
                        <thead>
                            <tr>
                                <th width="10%" style="text-align:center;">Owner ID</th>
                                <th width="10%" style="text-align:center;">Group code</th>
                                <th width="15%" style="text-align:center;">S/N</th>
                                <th width="15%" style="text-align:center;">Model</th>
                                <th width="15%" style="text-align:center;">Photo</th>
                                <th width="10%" style="text-align:center;">Registration date</th>
                                <th width="10%" style="text-align:center;">Approval</th>
                                <th width="15%" style="text-align:center;">Comment</th>
                            </tr>
                        </thead>

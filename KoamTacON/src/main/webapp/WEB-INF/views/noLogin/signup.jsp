	                ...
	                <div class="12u$">
	                    <form id="frmMain">
	                        ...
	                        <div class="row uniform">
	                            ...
	                            <div class="12u 12u$">
	                            	<a href="<c:url value='/noLogin/terms' />"><spring:message code='MSG-VW012' text='By signing in, you agree to our Terms of Use.' /></a>
	                            </div>
	                        </div>
	                    </form>
	                </div>
		...
		if (id.length < 8) {
			...
			if (bool) {
				...
				if (bool && isNaN(id)) {
					var param = "";
				    param += "userId="+id;
				    gf_send("<c:url value='/noLogin/isExist' />", param, "fn_isExistCallback");
				} else {
    ...
    if (gfn_checkRequired(frmId) === true) {
        ...
        if (gfn_checkFormat(frmId) === true) {
            ...
            if (gfn_checkPassword(frmId) === true) {
                ...
                $("#password").val("");
            	gf_sendForm(frmId, "<c:url value='/noLogin/insertSign' />", "fn_submitCallback");
            }
        	*/
        	gf_sendForm(frmId, "<c:url value='/noLogin/useRequest' />", "fn_submitCallback");
        }
    }
}

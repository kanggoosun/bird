...
function fn_submit() {
    ...
    if (gfn_checkRequired(frmId) === true) {
        if (gfn_checkFormat(frmId) === true) {
            gf_sendForm(frmId, "<c:url value='/sign/updateSign' />", "fn_submitCallback");
        }
    }
}
...
function fn_submitCallback(data) {
    ...
    if (result === "success") {
        ...
        gf_submitMovePage("<c:url value='/sign/userProfile' />");
    } else {
    ...
    if (gfn_checkRequired(frmId) === true) {
    	if ($("#newPassword").val() === $("#newPasswordConfirm").val()) {
    		if (fn_checkPassword($("#newPassword").val(), "newPassword")) {
	            ...
	            gf_sendForm(frmId, "<c:url value='/sign/changePassword' />", "fn_changePasswordCallback");

					...
					<div class="posts">
						<article>
							...
							<p>
								...
								<c:out value="${kdcMap.dayKdc }" />
							</p>
							<p>
								In the last 7 days :
								<c:out value="${kdcMap.weekKdc }" />
							</p>
							<p>
								In the last month :
								<c:out value="${kdcMap.monthKdc }" />
							</p>
						</article>
						<article>
							<h3>Group</h3>
							...
							<p>
								In the last 24 hours :
								<c:out value="${groupsMap.dayGroups }" />
							</p>
							<p>
								In the last 7 days :
								<c:out value="${groupsMap.weekGroups }" />
							</p>
							<p>
								In the last month :
								<c:out value="${groupsMap.monthGroups }" />
							</p>
						</article>
						<article>
							<h3>User</h3>
							...
							<p>
								In the last 24 hours :
								<c:out value="${usersMap.dayUsers }" />
							</p>
							<p>
								In the last 7 days :
								<c:out value="${usersMap.weekUsers }" />
							</p>
							<p>
								In the last month :
								<c:out value="${usersMap.monthUsers }" />
							</p>
						</article>
					</div>
				</section>

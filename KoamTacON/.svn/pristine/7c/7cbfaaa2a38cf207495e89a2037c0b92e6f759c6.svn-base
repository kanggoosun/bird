...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <div class="inner">
            ...
            <section>
                <header class="main">
                    <h2><spring:message code='MENU-RENTAL' text='Rental' /></h2>
                </header>
    ...
    <div id="contract_layer" class="popcont-layer">
        <div class="pop-container">
            <div class="pop-conts">
                ...
                <!--// content-->
                <div class="btn-r">
                    <a href="#" id="closeContractPopup" class="btn-layerClose"><spring:message code='WRD-CLOSE' text='Close' /></a>
                </div>
            </div>
        </div>
    </div>
...
function fn_makeDivBtn(divBtnId) {
    ...
    if (gvGroupCode != null && gvGroupCode != "" && gvGroupCode != "undefined") {
        ...
        divHtml += "    <li><input type=\"button\" name=\"btnRentalView\" id=\"btnRentalView\" value=\"<spring:message code='WRD-LIST' text='LIST' />\" class=\"button\" /></li>";
...
function fn_makeTblApplicationDataWithRental(applicationDataList, paginationHtml, applicationDef) {
    ...
    tblHtml += "    <thead>";
    tblHtml += "        <tr>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-RENTALSEQ' text='Rental Seq' /></th>";
    ...
    if (applicationDataList != null && applicationDataList.length > 0) {
        ...
        buttonHtml += "    <li><input type=\"button\" name=\"btnExcelExportRental\" id=\"btnExcelExportRental\" value=\"<spring:message code='WRD-EXPORT' text='Export' />\" class=\"button special fit\" /></li>";
...
function fn_makeTblApplicationDataWithCategory(applicationDataList, paginationHtml) {
    ...
    tblHtml += "    <thead>";
    tblHtml += "        <tr>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-KEYLEVEL' text='Key Level' />1</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-CATELEVEL' text='Category Level' />1</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-INFOLEVEL' text='Info Level' />1</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-KEYLEVEL' text='Key Level' />2</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-CATELEVEL' text='Category Level' />2</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-INFOLEVEL' text='Info Level' />2</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-KEYLEVEL' text='Key Level' />3</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-CATELEVEL' text='Category Level' />3</th>";
    tblHtml += "            <th style=\"text-align:center;\"><spring:message code='WRD-INFOLEVEL' text='Info Level' />3</th>";
    tblHtml += "        </tr>";
    tblHtml += "    </thead>";
    tblHtml += "    <tbody style=\"text-align:center;font-size:0.8em;\">";
    if (applicationDataList != null && applicationDataList.length > 0) {
        ...
        pageHtml = paginationHtml;
        buttonHtml += "<ul class=\"actions\">";
        buttonHtml += "    <li><input type=\"button\" name=\"btnDowonloadCategoryTemplate\" id=\"btnDowonloadCategoryTemplate\" value=\"<spring:message code='WRD-EXLTMLDWN' text='Excel Template Download' />\" class=\"button special fit\" /></li>";
        buttonHtml += "    <li><input type=\"button\" name=\"btnExcelImportCategory\" id=\"btnExcelImportCategory\" value=\"<spring:message code='WRD-IMPORT' text='Import' />\" class=\"button special fit\" /></li>";
        buttonHtml += "    <li><input type=\"button\" name=\"btnExcelExportCategory\" id=\"btnExcelExportCategory\" value=\"<spring:message code='WRD-EXPORT' text='Export' />\" class=\"button special fit\" /></li>";
        buttonHtml += "</ul>";
    } else {
